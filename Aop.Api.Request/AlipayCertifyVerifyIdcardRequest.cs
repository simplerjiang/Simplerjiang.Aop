...
namespace Aop.Api.Request
{
	public class AlipayCertifyVerifyIdcardRequest : IAopRequest<AlipayCertifyVerifyIdcardResponse>
	{
		...
		public string CertifyFrom
		{
			get;
			set;
		}

		public string ForcePublic
		{
			get;
			set;
		}
		...
		public IDictionary<string, string> GetParameters()
		{
			...
			aopDictionary.Add("biz_from", BizFrom);
			aopDictionary.Add("biz_id", BizId);
			aopDictionary.Add("cert_name", CertName);
			aopDictionary.Add("cert_no", CertNo);
			aopDictionary.Add("certify_from", CertifyFrom);
			aopDictionary.Add("force_public", ForcePublic);

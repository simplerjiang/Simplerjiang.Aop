...
{
	public class AlipayEbppConfigChargeinstSearchRequest : IAopRequest<AlipayEbppConfigChargeinstSearchResponse>
	{
		...
		public IDictionary<string, string> GetParameters()
		{
			...
			aopDictionary.Add("city", City);
			aopDictionary.Add("order_type", OrderType);
			aopDictionary.Add("province", Province);

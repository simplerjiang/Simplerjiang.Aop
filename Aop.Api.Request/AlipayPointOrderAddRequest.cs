...
namespace Aop.Api.Request
{
	public class AlipayPointOrderAddRequest : IAopRequest<AlipayPointOrderAddResponse>
	{
		...
		public IDictionary<string, string> GetParameters()
		{
			...
			aopDictionary.Add("order_time", OrderTime);
			aopDictionary.Add("point_count", PointCount);
			aopDictionary.Add("user_symbol", UserSymbol);
			aopDictionary.Add("user_symbol_type", UserSymbolType);
